...
(function () {
    ...
    function anagraficaRegioniController($http, DTOptionsBuilder, DTColumnDefBuilder) {
        ...
        vm.selezionaNazione = function selezionaNazione() {
            ...
            vm.pulsanteInserimentoVisibile = (vm.nazioneSelezionata.nazione != "-");  // Si può inserire una regione solo in una nazione esistente, non nella nazione indeterminata
        };
