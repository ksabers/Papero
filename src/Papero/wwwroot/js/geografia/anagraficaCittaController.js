...
(function () {
    ...
    function anagraficaCittaController($http, DTOptionsBuilder, DTColumnDefBuilder) {
        ...
        vm.selezionaProvincia = function selezionaProvincia() {
            ...
            vm.pulsanteInserimentoVisibile = (vm.provinciaSelezionata.provincia != "-");  // Si può inserire una città solo in una provincia esistente, non in quella indeterminata
        };
